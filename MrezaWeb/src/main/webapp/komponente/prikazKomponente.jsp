...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
		<h1>Informacije</h1>
		<p class = "w3-text-grey">Naziv komponente: ${komponenta.nazivKomponente }</p><br>
		<p class = "w3-text-grey">Tip komponente: ${komponenta.tipkomponente.nazivTipa}</p><br>
		<p class = "w3-text-grey">Opis komponente: <br>${komponenta.opis}</p><br>
    </div>
  </div>
</div>
