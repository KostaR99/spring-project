...
<!-- First Grid -->
<sf:form modelAttribute="komponenta" action = "/Mreza/admin/dodajKomponentu" method = "post">
	<div class="w3-row-padding w3-padding-64 w3-container w3-center">
		<div class="w3-content w3-center">
		<div class="w3-content1 w3-center">
			<p>Naziv komponente: </p><sf:input path="nazivKomponente" class = "w3-input"/><br><br>
			<p>Tip komponente: </p><sf:select path="tipkomponente" items="${tipovi}" itemValue="idtipKomponente" itemLabel="nazivTipa" class = "w3-select w3-bordered"/><br><br>
			<p>Opis komponente: </p><br><br>
			</div>
			<sf:textarea path="opis" rows="10" cols="100"/><br><br>
			<input type="submit" value="Sacuvaj Komponentu" class="w3-button w3-black w3-center">		
		</div>
	</div>
</sf:form>
