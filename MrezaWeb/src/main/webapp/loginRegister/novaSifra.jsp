...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PROMENA SIFRE</h1>
</header>
...
<div class="w3-row-padding w3-padding-64 w3-container w3-center">
  ...
  <div class="w3-content1">
  	<form action="/Mreza/sacuvajNovuSifru" method="get">
		<p>Unesite novu sifru</p><input type="password" name = "password" placeholder="unesite novu sifru" required="required" class = "w3-input"><br><br>
		<input type="submit" value = "Sacuvaj novu sifru" class = "w3-black w3-button">
	</form>
  </div>
</div>
