...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">REGISTRACIJA</h1>
</header>

<!-- First Grid -->
<div class="w3-row-padding w3-padding-64 w3-container">
	<div class="w3-content1 w3-center">
		<sf:form modelAttribute="korisnik" action="register" method="post">
			
			<p>Email:</p> <sf:input path="email" class = "w3-input" required="required"/>
			<p>Korisnicko ime: </p> <sf:input path="username" class = "w3-input" required="required"/>
			<p>Sifra: </p> <sf:password path="password" class = "w3-input" required="required"/><br><br><br>
			
			<input type="submit" value="Registruj se" class="w3-button w3-black">
		</sf:form>
	</div>
</div>
