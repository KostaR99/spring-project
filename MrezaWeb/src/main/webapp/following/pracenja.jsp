...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
	<c:if test="${empty ja }">
  		<h1 class="w3-margin w3-jumbo">Pracenja korisnika ${korisnik.username }</h1>
  	</c:if>
  	<c:if test="${not empty ja }">
  		<h1 class="w3-margin w3-jumbo">Moja pracenja</h1>
  	</c:if>
</header>
