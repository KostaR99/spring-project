...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">DOBRO DOSLI!</h1>
  <a href = "/Mreza/auth/loginPage"><button class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Prijavi se</button></a>
</header>

<div class="w3-row-padding w3-padding-64 w3-container w3-center">
  <div class="w3-content w3-animate-bottom">
      <h1>Pravila i mogucnosti</h1>
      <p class="w3-text-grey">Pravila sajta:<br>1) Bez vredjanja drugih korisnika ili admin tima<br>2) Bez neprimerenih reci<br>3) Bez spamovanja korisnika ili admin tima<br>Mogucnosti korisnika:
      Korisnici imaju mogucnost da pogledaju sve javne konfiguracije koje su napravljene od admin tima ali takodje i da naprave svoje privatne konfiguracije. Takodje korisnici mogu pretrazivati druge korisnike i videti njihove statuse<br>
      i njihove privatne konfiguracije.
      </p>
  </div>
</div>
