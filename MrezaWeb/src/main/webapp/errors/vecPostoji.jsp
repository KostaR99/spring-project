...
<!DOCTYPE html>
<html lang="en">
<title>Greska, korisnik vec postoji</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">DOSLO JE DO GRESKE!</h1>
  <p class="w3-xlarge">Korisnik sa ovim ${poruka} vec postoji, morate koristiti druge informacije za registrovanje</p>
</header>
