...
<!DOCTYPE html>
<html lang="en">
<title>Prikaz konfiguracija korisnika</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIKAZ SVIH KONFIGURACIJA KORISNIKA ${korisnik.username}</h1>
</header>

<!-- First Grid -->
<div class="w3-container w3-center">
  <div class="w3-content">
		<c:if test="${not empty konfiguracije }">
			<table class = "w3-table-all w3-bordered w3-center">
				<tr>
					<th>Naziv konfiguracije</th>
					<th>Namena konfiguracije</th>
					<th>Detaljniji opis</th>
				</tr>
				<c:forEach items="${konfiguracije }" var="k">
					<tr>
						<td>${k.nazivPrivKonf}</td>
						<td>${k.namena}</td>
						<td><a href = "/Mreza/prikazKonfKorisnika?idKonf=${k.idprivatnaKonfiguracija}">detaljnije</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
