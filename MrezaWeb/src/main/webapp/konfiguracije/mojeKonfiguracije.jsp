...
<!DOCTYPE html>
<html lang="en">
<title>Prikaz mojih konfiguracija</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIKAZ MOJIH KONFIGURACIJA</h1>
</header>
			...
			<table class = "w3-table-all w3-bordered w3-center">
				...
				<c:forEach items="${konfiguracije }" var="k">
					<tr>
						...
						<td>${k.namena}</td>
						<td><a href = "/Mreza/user/privKonfInfo?idKonf=${k.idprivatnaKonfiguracija}">detaljnije</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
