...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class = "w3-third w3-content">    	
    	<img alt="" src="${pageContext.request.contextPath}/pictures/profilna1.png" class ="w3-image">
    </div>
    <div class="w3-twothird">
		<h1>Informacije</h1>
		<p class = "w3-text-grey">Naziv konfiguracije: ${konfiguracija.nazivKonfiguracije }</p><br>
