...
<!DOCTYPE html>
<html lang="en">
<title>Prikaz javnih konfiguracija</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIKAZ SVIH JAVNIH KONFIGURACIJA</h1>
</header>
		...
		<c:if test="${not empty konfiguracije }">
			<table class = "w3-table-all w3-bordered w3-center">
				...
				<c:forEach items="${konfiguracije }" var="k">
					<tr>
						<td>${k.nazivKonfiguracije}</td>
						<td>${k.namena}</td>
						<td><a href = "/Mreza/javKonfInfo?idKonf=${k.idjavnaKonfiguracija}">detaljnije</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
