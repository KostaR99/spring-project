...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">OBJAVLJIVANJE STATUSA</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
	<div class="w3-content w3-animate-bottom w3-center">
		<p>Napisite sta trenutno mislite</p>
		<sf:form modelAttribute="status" method="post" action="/Mreza/user/napraviStatus">
			<sf:textarea path="sadrzaj" rows="10" cols="100" required="required"/><br><br>
