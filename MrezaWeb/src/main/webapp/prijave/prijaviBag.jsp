...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIJAVA BAGA</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
	<div class="w3-content w3-animate-bottom w3-center">
		<p>Napisite opis baga, na kojoj stranici se nalazi, kada se tacno desava...</p>
		<sf:form modelAttribute="bagPrijava" method="post" action="/Mreza/user/prijavaBaga">
			<sf:textarea path="opisBaga" rows="20" cols="100" required="required"/><br><br>
			<input type="submit" value="Prijavi bag" class="w3-button w3-black">
		</sf:form>
