...
<!DOCTYPE html>
<html lang="en">
<title>Prikaz priava korisnika</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIKAZ PRIJAVA KORISNIKA</h1>
</header>

<!-- First Grid -->
<div class="w3-container w3-center">
  <div class="w3-content">
		<c:if test="${not empty prijaveKorisnika }">
			<table class = "w3-table-all w3-bordered w3-center">
				...
				<c:forEach items="${prijaveKorisnika }" var="p">
					<tr>
						<td>${p.idkorisnikPrijave}</td>
						<td>${p.korisnik.username}</td>
						<td><a href = "/Mreza/admin/prikazPrijaveKorisnika?idPrijave=${p.idkorisnikPrijave}&username=${p.korisnik.username}">detaljnije</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
