...
<!DOCTYPE html>
<html lang="en">
<title>Prikaz prijave korisnika</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIJAVA KORISNIKA ID: ${prijava.idkorisnikPrijave }</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
	<div class="w3-center w3-content w3-animate-bottom">
  		...
  		<br><br>
  		<h4>Opis prijave</h4>
  		<p class ="w3-text-grey">${prijava.opisPrijave}</p>
	</div>
</div>
