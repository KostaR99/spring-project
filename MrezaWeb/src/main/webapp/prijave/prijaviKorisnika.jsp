...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">PRIJAVA KORISNIKA</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
	<div class="w3-content w3-animate-bottom w3-center">
		<p>Napisite username korisnika, nacin kako je vas je ometao, kako je prestupio pravila ovog sajta...</p>
		<sf:form modelAttribute="korisnikPrijava" method="post" action="/Mreza/user/prijavaKorisnika">
			<sf:textarea path="opisPrijave" rows="20" cols="100" required="required"/><br><br>
			<input type="submit" value="Prijavi korisnika" class="w3-button w3-black">
		</sf:form>
